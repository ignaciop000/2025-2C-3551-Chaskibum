...
public abstract class Tank
{
    ...
    private Texture2D _hullATexture;
    private Texture2D _hullBTexture;
    private Texture2D _hullCTexture;
    ...
    private readonly List<ImpactLocal> _impactsLocal = new();
    ...
    public void AddImpact(Vector3 worldImpactPosition, int boneIndex)
    {
        ...
        _impactsLocal.Add(new ImpactLocal { Local = local, Radius = ImpactRadius, BoneIndex = boneIndex });
    }
        ...
        Terrain terrain = null)
    {
        ...
        _hullATexture = content.Load<Texture2D>(TGCGame.ContentFolder3D + "t90/textures_mod/hullA");
        _hullBTexture = content.Load<Texture2D>(TGCGame.ContentFolder3D + "t90/textures_mod/hullB");
        _hullCTexture = content.Load<Texture2D>(TGCGame.ContentFolder3D + "t90/textures_mod/hullC");
        _treadmillsTexture = content.Load<Texture2D>(TGCGame.ContentFolder3D + "t90/textures_mod/treadmills");
        ...
        TargetCamera targetLightCamera, BoundingFrustum boundingFrustum)
    {
        ...
        foreach (var mesh in _model.Meshes)
        {
            ...
            if (mesh.Name.Contains("Treadmill"))
            {
                ...
                _effect.Parameters["ModelTexture"]?.SetValue(_treadmillsTexture);
            }
            else
            {
                _effect.CurrentTechnique = _effect.Techniques["BasicDrawing"];
