...
namespace TGC.MonoGame.TP 
{
    public class Tank 
    {
        ...
        {
            for (int j = 0; j < bodyHandles.Count; j++)
            {
                BodyHandle bodyHandle = bodyHandles[j]; 
                ...
                var rotMg = new Quaternion(bodyPose.Orientation.X, bodyPose.Orientation.Y, bodyPose.Orientation.Z, bodyPose.Orientation.W);
